...
DEFAULT_ENDPOINT = "https://api.novelai.net"
...
def get_help_text() -> str:
    return (
        ...
        "绾︾ 涓€涓コ瀛╋紝鐚€砛n"
        "\n"
        "鏀瑰浘/img2img锛氬彂閫佸浘鐗囧苟闄勫甫锛歕n"
        "/nai draw 1girl, cat ears -N 0.7 -n 0.2\n"
        "/nai img 1girl, different clothes\n"
        "\n"
        "澧炲己/enhance锛氬彂閫?NovelAI 鐢熸垚鍥惧苟闄勫甫锛歕n"
        "/nai enhance masterpiece\n"
        "/nai draw masterpiece -e\n"
        "\n"
        "甯哥敤鍙傛暟锛歕n"
        "-r 灏哄 portrait/landscape/square/1024x1024\n"
        "-m 妯″瀷 nai-v3/nai-v4-full\n"
        "-s 閲囨牱鍣? -t 姝ユ暟  -c scale  -x seed\n"
        "-u 璐熼潰璇? -O 涓嶈拷鍔犻粯璁?prompt  -T 璺宠繃缈昏瘧\n"
        "-N 鏀瑰浘骞呭害 strength  -n 鍣０ noise\n"
        "-i 鐢熸垚杞暟  -b 姣忚疆寮犳暟  -o minimal/default/verbose\n"
